...
def encryptMessage(message, cipherKey, alphabet):
    encryptedMessage = ""
    uppercaseMessage = ""
    # uppercaseMessage = message # Huruf kecil tidak ketemu ketika dimatchkan dengan alphabet yang isinya besar semua
    uppercaseMessage = message.upper()
    for currentCharacter in uppercaseMessage:
        position = alphabet.find(currentCharacter) # Pencarian tidak ketemu disini
